...
(function(){
  ...
  $$('form[data-demo]').forEach(form=>{
    ...
    form.addEventListener('submit',e=>{
      ...
      // Formularze motywu sa ATRAPAMI: pokazuja podziekowanie i nic nie wysylaja.
      // Do 1.3.6 dwa z siedmiu mialy action="https://formspree.io/f/YOUR_FORM_ID" —
      // nigdy nieuzupelniony placeholder, widoczny w zrodle strony. Jesli formularz
      // dostanie kiedys prawdziwy endpoint, ponizszy fetch go obsluzy; bez niego
      // dzialamy w trybie demo, tak jak pozostale piec.
      const endpoint = form.getAttribute('action');
      if(!endpoint){ showOk(); return; }
