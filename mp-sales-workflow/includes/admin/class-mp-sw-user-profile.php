	...
	public static function render( $user ) {
		...
		<table class="form-table" role="presentation">
			<tr>
				...
				<td>
					<input type="text" id="mp-sw-country" name="<?php echo esc_attr( MP_SW_D2_Reader::META_COUNTRY ); ?>"
						value="<?php echo esc_attr( $kraj ); ?>" maxlength="2" size="4" class="regular-text" style="width:5em">
			...
			<tr>
				...
				<td>
					<input type="text" id="mp-sw-langs" name="<?php echo esc_attr( MP_SW_D2_Reader::META_LANGS ); ?>"
						value="<?php echo esc_attr( $jezyki ); ?>" class="regular-text">
			...
			<tr>
				...
				<td>
					<input type="text" id="mp-sw-team" name="<?php echo esc_attr( MP_SW_D2_Reader::META_TEAM ); ?>"
						value="<?php echo esc_attr( $zespol ); ?>" class="regular-text">
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="<?php echo esc_attr( MP_SW_D2_Reader::META_ACTIVE ); ?>" value="1" <?php checked( $aktywny ); ?>>
